            ...
            <div id="provider-top">
              ...
              <div class="logo-share">
                <?php
                  ...
                  //echo bvc_misc_getTrackingUrl('Visit Site', NULL, NULL, NULL, 'visit-site', array('key' => 'rel', 'value' => 'v:url nofollow'));
                  echo bvc_misc_getTrackingUrl('', NULL, NULL, NULL, 'visit-site', array('key' => 'rel', 'value' => 'v:url nofollow'));
              ...
              <div class="basic-info" rel="v:itemreviewed">
                <div typeof="Organization">
                  <?php 
                      ...
                      if (!empty($node->bvc_rating_overall)) {
                        echo '<div class="stars-rating">' . theme('bvc_misc_fivestar_static', array('rating' => $node->bvc_rating_overall * 20, 'stars' => 5, 'tag' => 'overall', 'widget' => array('name' => 'stars', 'css' => 'stars.css'))) . '<span>' . $node->bvc_rating_overall . '/5</span></div>'; 
                      }
                  ?>
                  ...
                  <div id="info-n-reviews">
                        ...
                        <div>
                          <?php 
                            if (!$node->p_data['info']['i_web_hide'] && !empty($node->p_data['info']['i_web'])) {
                              ...
                              echo '<span class="title">Website:</span>' . bvc_misc_getTrackingUrl($goto_link_title, NULL, NULL, NULL, NULL, array('key' => 'rel', 'value' => 'v:url nofollow'));
                            }
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="overall"> 
                        <?php 
                            ...
                            if (!empty($content['bvc_ratings'])): 
                        ?>

                              <?php 
                                 $no_reviews_class = NULL;
                                 echo '<div class="price narrow">', (empty($node->p_data['s']['bu']['fees']['mon']) ? '' : '$' . $node->p_data['s']['bu']['fees']['mon']), '</div>',
                                      '<div class="voters"><div class="title"><span class="not-narrow">Number of </span>Reviews:</div><div class="count" property="v:count"><a href="#reviews" rel="nofollow" >', $node->bvc_voters, '</a></div></div>',
                                      '<div class="recommend not-narrow"><div class="title">Would recommend: </div><div class="data">', $node->bvc_recommend, '% of Users</div></div>'
                                      ;
                              ?>

                        <?php /*else: ?>
                            <?php echo l('<img src="/sites/all/themes/bvc/css/images/writeareview2.png" alt="Write a Review" />', 'node/add/review', array('html' => TRUE, 'attributes' => array('id' => 'write-review', 'rel' => 'nofollow'), 'query' => array('id' => $node->nid))); ?>
                        <?php */endif; // end of if ($page && isset($content['bvc_ratings']) && $content['bvc_ratings']): ?>
                    </div>
...
//                          if ($user->uid) 
                            ...
                            $path_to_custom_js = drupal_get_path('module', 'bvc_pages') . '/js/';
                            drupal_add_js($path_to_custom_js . 'bvc_provider_popup_requestLinks.js');
                  ...
                  ?>
                            ...
                            <div style="display: none;">
                              <div id="block-bvc-blocks-request-quote-v8" class="popup-request quote"> 
                                ...
                                <?php echo bvc_blocks_get_requestQuote_block_v8_popup_provider(); ?>
                            ...
                            <div style="display: none;">
                              <div id="block-bvc-blocks-request-quote-v8" class="popup-request demo"> 
                                ...
                                <div class="bottom-clear"></div>
                                <?php echo bvc_blocks_get_requestDemo_block_v1_popup_provider(); ?>
              ...
              <?php if (!empty($content['bvc_ratings'])): ?>
                  <div class="bvc_votes main"><?php echo render($content['bvc_ratings']); ?>
                    <div class="total">
                      <?php 
                          ...
                          <span class="count" rel="v:rating">
                            <span typeof="v:Rating">
                              ...
                              <span property="v:value">' . $node->bvc_rating_overall . '</span>
                              <span property="v:best"  content="0"></span>
                            </span>
                          </span><div class="stars-rating">' . theme('bvc_misc_fivestar_static', array('rating' => $node->bvc_rating_overall * 20, 'stars' => 5, 'tag' => 'overall', 'widget' => array('name' => 'stars', 'css' => 'stars.css'))) . '</div>'; 

                      ?>
                    </div>
                  </div>
              <?php endif; // end of if (!empty($content['bvc_ratings'])): ?>
          ...
          <?php echo render($content['metatags']); //bvc_misc_renderMetatags_newOrder($content['metatags']);?>
