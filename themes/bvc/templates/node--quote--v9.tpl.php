  <?php
    if ($node->title == 'Request a Quote page v9 Final') {
//      $path_to_custom_js = drupal_get_path('module', 'bvc_blocks') . '/js/';
//      drupal_add_js($path_to_custom_js . 'bvc_brandsCarousel.js');
...
//      drupal_add_css('sites/all/libraries/jquery.plugins/jcarousel/skins/tango/skin.css');
      ...
      $initialQuotePage_node = bvc_misc_getInitialQuotePageNode($node->title);
...
<div id="v9">
  <div id="quote-content">
      ...
      <div class="full logo">
          ...
          <div id="bvc-logo">
            <div class="logo"><img src="http://businessvoipcenter.com/sites/all/themes/bvc/css/images/getvoip-logo8.png" alt="businessvoipcenter.com" title="businessvoipcenter.com" /></div>
          </div>
        ...
        <div id="main-content"> 
              ...
              <?php if ($_SERVER['REDIRECT_URL'] == '/lpv9-final'): ?>
                  ...
                  <div class="left final">
                    ...
                    <?php  
                      echo '<a class="guide" href="/pdfs/SMBVOIPAdvantagesWhitePaper.pdf" target="_blank">Download Your Free VoIP Buyer\'s Guide<img src="/sites/all/themes/bvc/css/images/click-here-button.png" /></a><div class="quote-final">' . t('<p><strong>Thank you</strong> for taking your time to complete our form. A VoIP Expert will be contacting you shortly to provide you with a personalized VoIP Service quote.</p><p>In the meantime, you can gain a great deal of VoIP information right here at <a href="http://businessvoipcenter.com">businessvoipcenter.com</a></p>') . '</div>';
                    ?>
                  </div>
              ...
              <?php else: ?>
                  ...
                  <div class="left">
                    ...
                    <div class="subtitle">In just a few minutes we will match you with VoIP vendors that offer the best systems for your exact needs.</div>
                     ...
                     <?php echo bvc_blocks_get_requestQuoteForPage_v9(); ?>
                  </div>
              ...
              <?php endif; ?>
                ...
                <div class="right-side">
                    <img src="http://businessvoipcenter.com/sites/all/themes/bvc/css/images/lp8-image.png" />
      ...
      <div class="full bottom">
        ...
        <div id="bottom-inside">
            ...
            <div class="right">
              ...
              <img src="http://businessvoipcenter.com/sites/all/themes/bvc/css/images/lp8-image2.png" />
            </div>
      ...
      <div class="full excerpt">
          ...
          <div id="upper-block">
            ...
            <div class="quotes one">
              <div class="text"><span></span>businessvoipcenter.com stands out in the business VoIP implementation space by providing expert analysis and unparalleled information along with hands-on reviews and comparisons.<div></div></div>
      ...
      <footer id="footer" role="contentinfo" class="region-footer clearfix">
        <div id="footer-inside">
          ...
          <div class="left">businessvoipcenter.com is an independent VoIP service comparison guide, offering unbiased personalized quotes and exclusive reports.</div>
          <div class="right"><img src="http://businessvoipcenter.com/sites/all/themes/bvc/css/images/getvoip-logo8.png" alt="businessvoipcenter.com" title="businessvoipcenter.com" /><div>© 2014 | All Rights Reserved</div></div>
...
</div> <!-- End of <div id="v9"> -->



<?php if ($_SERVER['REDIRECT_URL'] == '/lpv9-final'): /* If we are on the final page, after the submission */ ?> 

          <?php /*if ($_SERVER['HTTP_REFERER'] == 'http://businessvoipcenter.com/lpv9'):*/  /* If we get the final page from the main quote page, what is correct.*/ ?> 
          ...
          <?php /*global $user; elseif ($user->uid != 1): // If we get the final page from an other page, what is INCORRECT, we just redirect a user to the main quote page.?>
            <script>top.location.href="http://businessvoipcenter.com/lpv9";</script>
          <?php endif;*/?>
