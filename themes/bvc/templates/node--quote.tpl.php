...
<div class="partners">
  ...
  <a id="sitelock" href="#" onclick="window.open('https://www.sitelock.com/verify.php?site=businessvoipcenter.com','SiteLock','width=600,height=600,left=160,top=170');" ><img alt="website security" title="SiteLock"  src="//shield.sitelock.com/shield/businessvoipcenter.com"/></a> 
</div>
  ...
  <div class="left">
    <?php 
      if ($_SERVER['REDIRECT_URL'] == '/request-voip-phone-system-quote-final') {
        ...
        echo bvc_blocks_get_requestQuoteForPage(); 
      }
    ?>
  </div>
...
<footer>
  ...
  <div class="copy">© 2012 businessvoipcenter.com | All Rights Reserved</div>
  <div class="copy">BizMedia Central LLC | New York, NY</div>
</footer>

<?php if ($_SERVER['REDIRECT_URL'] == '/request-voip-phone-system-quote-final'): ?> 
  <?php if ($_SERVER['HTTP_REFERER'] == 'http://businessvoipcenter.com/request-voip-phone-system-quote'): ?> 
  ...
  <?php else:?>
    <script>top.location.href="http://businessvoipcenter.com/request-voip-phone-system-quote";</script>
  <?php endif;?>
<?php endif;?>
