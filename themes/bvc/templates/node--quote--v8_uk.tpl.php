              ...
              <?php else: ?>
                  ...
                  <div class="left">
                    ...
                    <div class="subtitle">In just a few minutes we will match you with VoIP vendors that offer the best systems for your exact needs.</div>
                     ...
                     <?php echo bvc_blocks_get_requestQuoteForPage_v8_uk(); ?>
                  </div>
      ...
      <div class="full bottom">
        ...
        <div id="bottom-inside">
            ...
            <div class="right">
              ...
              <img src="http://businessvoipcenter.com/sites/all/themes/bvc/css/images/lp8uk-image2.jpg" />
            </div>
...
<?php if ($_SERVER['REDIRECT_URL'] == '/lpv8-uk-final'): /* If we are on the final page, after the submission */ ?> 
          ...
          <?php /*global $user; elseif ($user->uid != 1): // If we get the final page from an other page, what is INCORRECT, we just redirect a user to the main quote page.?>
            <script>top.location.href="http://businessvoipcenter.com/lpv8-uk";</script>
          <?php endif;*/?>
