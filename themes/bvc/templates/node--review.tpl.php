<?php 
 ...
 $all_data_quick = bvc_misc_getProvidersDataQuick();
 ...
 if($view_mode == 'home_teaser') {
  ...
  echo '<div class="header">';
      ...
      if ($_SERVER['REQUEST_URI'] == '/hosted-pbx' || !$image = bvc_misc_getProviderLogoFromSprite($provider_nid, $sprite_name, $all_data_quick)) {
        $image_style_name = 'logo_provider_chart_main'; //'thumbnail';
        $image = theme('bvc_misc_image_style', array('style_name' => $image_style_name, 'path' => $all_data_quick[$provider_nid]['i_logo_uri'], 'alt' =>  $all_data_quick[$provider_nid]['i_logo_alt'], 'title' =>  $all_data_quick[$provider_nid]['i_logo_title'] ));
      }
      
      if (!empty($all_data_quick[$provider_nid]['i_web'])) {
        //$logo_link = $all_data_quick[$provider_nid]['i_web'];
        echo bvc_misc_getTrackingUrl($image, NULL, $provider_nid, NULL, 'logo', NULL, $all_data_quick[$provider_nid]);
      }
      else {
        echo '<a class="logo" href="' . url('node/' . $provider_nid) . '">' . $image . '</a>';
      }
      
      //$out = bvc_misc_getTrackingUrl($image, NULL, $data['data']->nid);
      ...
      $stars = theme('bvc_misc_fivestar_static', array('rating' => $node->field_r_rating_overall['und'][0]['value'] * 20, 'stars' => 5, 'tag' => 'overall', 'widget' => array('name' => 'stars', 'css' => 'stars.css')));
...
elseif($view_mode == 'servicePage_bottomMainReviewTeaser') {
  ...
  echo '<div class="header"><table><tbody><tr><td>';
      ...
      echo bvc_misc_getTrackingUrl('VISIT', NULL, $provider_nid, NULL, 'link', array('key' => 'rel', 'value' => 'nofollow'), $all_data_quick[$provider_nid]);
  ...
  $stars = '<div class="rating">' . $stars . l('See All ' . $all_data_quick[$provider_nid]['name'] . ' Reviews', 'node/' . $provider_nid, array('attributes' => array('class' => array('more'), 'rel' => 'nofollow'))) . '</div>';
...
?>
  ...
  <div class="main-content" <?php echo ($full_title ? '' : 'xmlns:v="http://rdf.data-vocabulary.org/#" typeof="v:Review"'); /*echo ($page ? ' xmlns:v="http://rdf.data-vocabulary.org/#" typeof="v:Review"' : '');*/  ?>>
      ...
      ?>
      <div class="reviewer">
        <div class="r-avatar"><img src="/sites/all/themes/bvc/css/images/avatar.jpg"></div>
      ...
      <div class="review-wrapper">
          ...
          <div class="bvc_votes">
            ...
            <?php echo render($content['bvc_ratings']); ?>
            <div class="caption">
                <?php 
          ...
          </div> <!-- End of <div class="bvc_votes"> -->
