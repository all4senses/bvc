...
<!-- <a href="https://plus.google.com/+businessvoipcenter.com?rel=author"></a> -->
  <?php 
      ...
      //$url = 'http://businessvoipcenter.com' . ($_GET['q'] == 'home' ? '' : $_SERVER['REQUEST_URI']);

      
//      $url = 'http://businessvoipcenter.com' . ($_GET['q'] == 'home' ? '' : bvc_misc_getOlderUrlForSharing($_SERVER['REQUEST_URI']));
//
//      $share_title = NULL;
//
//      if ($is_front) {
//        $share_title = bvc_misc_metatag_getFrontTitle();
//      }
//
//      if (!$share_title) {
...
//                    }
//                  }
//                  echo bvc_blocks_getSocialiteButtons($url, $share_title); 
//
//                }
              ?> 
