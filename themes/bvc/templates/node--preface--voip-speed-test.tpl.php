<?php
      ...
      $url = 'http://businessvoipcenter.com' . $_SERVER['REQUEST_URI'];
      ...
      $module_path = drupal_get_path('module', 'bvc_misc');
      drupal_add_js( $module_path . '/js/bvc_floatingSocials.js'); 
...
// Ookla speed test page original content. -------------------------------------------------------------------------------
  ...
  drupal_add_js($path_to_custom_js . 'bvc_speedtest_page.js');
