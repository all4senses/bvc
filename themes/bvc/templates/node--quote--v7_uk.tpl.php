  <?php
    if ($node->title == 'Request a Quote page v7_uk Final') {
  ...
  <div id="quote-content">
        ...
        <div id="main-content">
              ...
              <?php
                ...
                //if ($user->uid) 
                {
                  ...
                  $path_to_custom_js = drupal_get_path('module', 'bvc_misc') . '/js/';
                  drupal_add_js($path_to_custom_js . 'bvc_exitIntent_lpV4.js');
                  */
                }
              ...
              <?php if ($_SERVER['REDIRECT_URL'] == '/service-quotes-uk-final'): ?>
              ...
              <?php else: ?>
                  ...
                  <div class="right">
                    <div id="right-bottom">
                      <?php echo bvc_blocks_get_requestQuoteForPage_v7_uk(); ?>
                      <div class="bottom-clear"></div> 
                    </div>
                  </div>
      ...
      <div class="full excerpt">
          ...
          <div id="upper-block">
            ...
            <div class="quotes one">
              <div class="text"><span></span>businessvoipcenter.com stands out in the business VoIP implementation space by providing expert analysis and unparalleled information along with hands-on reviews and feature explanations, which ultimately translates into an easy to setup and manage phone system.<div></div></div>
      ...
      <footer id="footer" role="contentinfo" class="region-footer clearfix">
        <div id="footer-inside">
          ...
          <?php
              //echo '<div id="block-bvc-blocks-follow-links"><div class="follow-us">Follow Us</div>', bvc_blocks_get_headerLinks(), '</div>';
              //echo bvc_blocks_getBlockThemed(array('module' => 'bvc_blocks', 'delta' => 'footer_menu', 'no_subject' => TRUE, /*'class' => 'block-om-maximenu',*/ 'shadow' => FALSE), TRUE, '+31 day');
          ?>
...
<?php if ($_SERVER['REDIRECT_URL'] == '/service-quotes-uk-final'): /* If we are on the final page, after the submission */ ?> 
          ...
          <?php /*global $user; elseif ($user->uid != 1): // If we get the final page from an other page, what is INCORRECT, we just redirect a user to the main quote page.?>
            <script>top.location.href="http://businessvoipcenter.com/service-quotes-uk";</script>
          <?php endif;*/?>
    
<?php else: // Else of if ($_SERVER['REDIRECT_URL'] == '/service-quotes-uk-final'):
// So we are on the lending page '/service-quotes-uk' 
?>
...
<?php endif; // End of Else of if ($_SERVER['REDIRECT_URL'] == '/service-quotes-uk-final'):?>
