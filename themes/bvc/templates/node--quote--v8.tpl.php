  <?php
    if ($node->title == 'Request a Quote page v8 Final') {
              ...
              <?php else: ?>
                  ...
                  <div class="left">
                    ...
                    <div class="subtitle">In just a few minutes we will match you with VoIP vendors that offer the best systems for your exact needs.</div>
                     ...
                     <?php echo bvc_blocks_get_requestQuoteForPage_v8(); ?>
                  </div>
...
<?php if ($_SERVER['REDIRECT_URL'] == '/lpv8-final'): /* If we are on the final page, after the submission */ ?> 
          ...
          <?php /*if ($_SERVER['HTTP_REFERER'] == 'http://businessvoipcenter.com/lpv8'):*/  /* If we get the final page from the main quote page, what is correct.*/ ?> 
          ...
          <?php /*global $user; elseif ($user->uid != 1): // If we get the final page from an other page, what is INCORRECT, we just redirect a user to the main quote page.?>
            <script>top.location.href="http://businessvoipcenter.com/lpv8";</script>
          <?php endif;*/?>
