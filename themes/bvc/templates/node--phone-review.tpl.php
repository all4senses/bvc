...
<?php endif; ?>
  ...
  <div class="main-content"  xmlns:v="http://rdf.data-vocabulary.org/#" typeof="v:Review">
        ...
        <div class="content"<?php print $content_attributes; ?>>
          ...
          <div class="bvc_votes">
            <?php echo '<div class="caption"><span>' , t('User\'s Rating') , ':</span> <span property="v:rating">' , $node->field_r_rating_overall['und'][0]['value'], '</span>' /* render($content['bvc_rating_overall'])*/ , '<div class="bottom-clear"></div></div>' , render($content['bvc_ratings']); ?>
            <div class="rate-other">
              ...
              <?php endif; ?>
              <div class="text"><?php echo '<div class="title">' . t('Recommend') . ': </div><div class="data">' . $node->bvc_recommend . '</div>'?></div>
            </div>
          </div>
