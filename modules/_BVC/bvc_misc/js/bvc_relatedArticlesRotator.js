(function ($) {
  ...
  Drupal.behaviors.bvc_relatedArticlesRotator = {
...
//            
//            $('#block-bvc-blocks-sidebar-related-articles.block .content')[0].original_title_height = $('#block-bvc-blocks-sidebar-related-articles.block .content').css('height');
//            $('#block-bvc-blocks-sidebar-related-articles.block .content').css('height', 'inherit');
//          },  
//          function() {  
//            $(this).css('height', $(this)[0].original_title_height);
//            $('#block-bvc-blocks-sidebar-related-articles.block .content').css('height', $('#block-bvc-blocks-sidebar-related-articles.block .content')[0].original_title_height);
//          }  
//      );
