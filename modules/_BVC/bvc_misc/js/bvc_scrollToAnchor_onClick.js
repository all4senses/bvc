(function ($) {
  ...
  Drupal.behaviors.bvc_scrollToAnchor_onClick = {
    attach: function (context, settings) {
        ...
        $(".scroll-to-link").click(function (event) {
            ...
            hash = this.hash;
            // Make a beautiful link - show on a link #find-solution but go to #block-bvc-blocks-home-service-types
            if (hash == '#find-solution') {
              hash = '#block-bvc-blocks-home-service-types';
            }
